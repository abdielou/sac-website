    ...
    <div className="divide-y divide-gray-200 dark:divide-gray-700">
      ...
      <div className="items-start space-y-2 py-4 xl:grid xl:grid-cols-1 xl:gap-x-8 xl:space-y-0">
        ...
        <div className="pt-4 pb-2 prose dark:prose-dark max-w-none">
          La Sociedad de Astronomia del Caribe es una organizacion sin fines de lucro 501(c)(3) que
          ofrece varias actividades educativas y de observacion astronomica durante el ano en
