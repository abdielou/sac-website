...
/**
 * Create a new QueryClient with member-area defaults
...
/**
 * MemberProviders wraps member pages with QueryClientProvider
 * Use in app/member/layout.js to enable TanStack Query for all member routes
 */
export function MemberProviders({ children }) {
