      ...
      <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
        <div>
          ...
          <h2 className="text-lg font-semibold text-gray-900 dark:text-white">
            {isEditing ? `Borrador (basado en ${doc?.version})` : `${doc?.version} — Activa`}
          </h2>
            ...
            {hasDraft && (
              <>
                <button
                  type="button"
                  onClick={onSaveDraft}
                  className="rounded-md border border-gray-300 dark:border-gray-600 px-3 py-2 text-sm font-medium text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700"
                >
                  Guardar borrador
                </button>
                <button
                ...
                <button
                  type="button"
                  onClick={onDiscard}
                  className="rounded-md px-3 py-2 text-sm text-gray-600 dark:text-gray-400 hover:underline"
                >
                  Descartar
                </button>
              </>
