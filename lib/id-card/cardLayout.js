...
export const LAYOUT = {
  ...
  element: {
    width: 137, // 153 - 2*PADDING, natural aspect 149.4:163.01 → height ≈ 150
    height: 150,
    top: PADDING,
  },
  photo: {
    size: 108, // prominent portrait framed by the outer ring
    top: PADDING + (150 - 108) / 2, // center photo on element
    borderRadius: 54,
  },
  ...
  infoColumn: {
    logo: { width: 52, height: 20, marginBottom: 1 },
