...
import { resolveContentTitle } from '../ai-content-data'
 ...
 * Headline: the configured titleSource read from contentData.
...
export function buildTemplateTextFields({
  ...
  const configuredHeadline = resolveContentTitle(input?.contentData || {}, definition)
  const headline = configuredHeadline || 'Sociedad de Astronomía del Caribe'
