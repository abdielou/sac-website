...
describe('Column Registry', () => {
  it('should contain all required default columns', () => {
    ...
    // Verify all 10 current default columns are present
    ...
    expect(defaultIds).toContain('phone')
    expect(defaultIds).toContain('familyMembers')
  ...
  it('should contain all additional columns', () => {
    ...
    // Verify additional columns are present (beyond the 9 defaults)
    ...
    expect(allIds).toContain('familyMembers')
