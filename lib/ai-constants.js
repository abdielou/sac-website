 ...
 * Not a runtime allowlist — active platforms come from the Guidelines document (ADR-0004).
 */
export const DEFAULT_SEED_PLATFORMS = ['x', 'instagram', 'facebook']

/** @deprecated Use DEFAULT_SEED_PLATFORMS — kept as alias for seed/fallback callers. */
export const PLATFORMS = DEFAULT_SEED_PLATFORMS
...
/** @deprecated Use DEFAULT_SEED_PLATFORM_LABELS — kept as alias for seed/fallback callers. */
export const PLATFORM_LABELS = DEFAULT_SEED_PLATFORM_LABELS
...
export function contentTypeAcceptsImages(platform, contentType, definition) {
  ...
  const posture =
    PLATFORM_MEDIA_POSTURE[String(platform || '').toLowerCase()] || 'mixed'
