...
const GENERATION_PLATFORM_GUIDELINES = {
  x: 'X: redacción concisa, máximo 280 caracteres por borrador; CTA breve si aplica. No añadir hashtags por defecto.',
  instagram:
    'Instagram: caption con gancho en la primera línea, tono visual y cercano; CTA clara si aplica. No añadir hashtags por defecto.',
  facebook:
    'Facebook: redacción más completa; para eventos incluir toda la información provista (nombre/fecha/hora/lugar) y CTA explícita si aplica; tono comunitario. No añadir hashtags por defecto.',
}
