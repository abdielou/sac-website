...
const CONTENT_TYPE_RULES = {
  ...
  [OBSERVATION_NIGHT_CONTENT_TYPE]: `${OBSERVATION_NIGHT_LABEL}: requiere fecha, hora, lugar y CTA. Conserva la etiqueta canónica vigente durante cada ejecución; marcar completeness si faltan datos variables.`,
  event_promotion:
...
const GENERATION_CONTENT_TYPE_RULES = {
  [OBSERVATION_NIGHT_CONTENT_TYPE]: `${OBSERVATION_NIGHT_LABEL}: conserva la etiqueta canónica vigente durante esta ejecución y usa únicamente la fecha, hora, lugar y CTA provistos; lista cualquier dato faltante en missingInformation en vez de inventarlo.`,
  event_promotion:
